...
if __name__ == "__main__":
    ...
    parser.add_argument('-bmin', help="Min bandwidth on any link", action="store", type=int, required=True)
    parser.add_argument('-bmax', help="Max bandwidth on any link", action="store", type=int, required=True)
