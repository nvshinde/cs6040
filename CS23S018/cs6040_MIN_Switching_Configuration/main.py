    ...
    def benes(self) -> None:            
        ...
        for i, outport in enumerate(self.outports):
            ...
            for stage in range(num_stages//2): 
                ...
                # lcurr_stage_sub_inport = lcurr_stage_sub_inport % int((self.n / (2**stage)))
                # lcurr_stage_global_inport = lcurr_stage_sub_inport # Need a better formula

                # rcurr_stage_sub_inport = rcurr_stage_global_inport % int((self.n / (2**stage)))
                # rcurr_stage_global_inport = rcurr_stage_sub_inport  # Need a better formula
